...
export const StatDescriptions: { [key: string]: string } = {
    ...
    siz: "크기 (SIZ): 탐사자 신체의 키와 체중.",
    dex: "민첩성 (DEX): 신체의 빠르고 민첩하고 유연한 정도.",
    app: "외모 (APP): 타인에게 보이는 매력 및 인상.",
    edu: "교육 (EDU):  보유한 정규 지식, 정식 교육을 이수하느라 보낸 시간.",
    int: "지능 (INT): 탐사자의 학습 능력, 기억력, 정보 분석 능력.",
    pow: "정신력 (POW): 탐사자가 가진 의지력.",
...
export const subStatDescriptions: { [key: string]: string } = {
    ...
    db: "체구 피해보너스: 탐사자 신체의 키와 체중.",
    SAN: "이성: 신체의 빠르고 민첩하고 유연한 정도.",
};
